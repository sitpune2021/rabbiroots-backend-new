...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    $isView = $mode === 'view';
    @endphp
    <form action="{{ $mode === 'edit' ? route('promo.update', $promo->id) : route('promo.store') }}" method="POST">
        @csrf
        @if($mode === 'edit')
        @method('PUT')
        @endif
            ...
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('code_name') is-invalid @enderror" id="codeName" name="code_name"
                                    placeholder="e.g., SAVE20"
                                    name="code_name"
                                    value="{{ old('code_name', $promo->code_name ?? '') }}"
                                    {{ $isView ? 'disabled' : '' }}
                                    >
                                @error('code_name')
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                @foreach(['percentage' => 'Percentage (%)', 'flat' => 'Flat Amount (₹)'] as $key => $label)
                                <div class="form-check">
                                    <input class="form-check-input" type="radio"
                                        name="discount_type"
                                        value="{{ $key }}"
                                        {{ old('discount_type', $promo->discount_type ?? 'percentage') === $key ? 'checked' : '' }}
                                        {{ $isView ? 'disabled' : '' }}>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('min_order_value') is-invalid @enderror"
                                        id="minOrderValue"
                                        name="min_order_value" placeholder="500"
                                        value="{{ old('min_order_value', $promo->min_order_value ?? '') }}"
                                        min="0"
                                        {{ $isView ? 'readonly' : '' }} >
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">₹</span>
                                    <input type="number" class="form-control @error('max_discount_cap') is-invalid @enderror" id="maxDiscountCap"
                                        name="max_discount_cap" placeholder="200"
                                        value="{{ old('max_discount_cap', $promo->max_discount_cap ?? '') }}"
                                        min="0"
                                        {{ $isView ? 'readonly' : '' }} >
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="store_type"
                                        id="specificStore" value="specific_store" disabled>
                                    <label class="form-check-label" for="specificStore">
                                        Specific Store(s) (Coming Soon)
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="new_users"
                                        id="newUsers" value="1"
                                        {{ old('new_users', $promo->new_users ?? false) ? 'checked' : '' }}
                                        {{ $isView ? 'disabled' : '' }}
                                        checked>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="all_users"
                                        id="allUsers" value="1" checked>
                ...
                <div class="d-flex justify-content-end gap-2" style="margin-top:20px;">
                    ...
                    <button type="submit" class="btn btn-primary">
                        ...
                        {{ $isAdd ? 'Create Promo' : 'Update Promo' }}
                    </button>
                    @endif
